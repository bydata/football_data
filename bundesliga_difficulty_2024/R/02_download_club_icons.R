...
target_dir <- "bundesliga_difficulty_2024/input/team_icons/"
...
icon_urls <- c(
  ...
  "FC Heidenheim" = "https://derivates.kicker.de/image/fetch/w_30,h_30,c_fit,q_auto:best/https://mediadb.kicker.de/2018/fussball/vereine/xxl/11306_20170721389.png",
  "Darmstadt 98"  = "https://derivates.kicker.de/image/fetch/w_30,h_30,c_fit,q_auto:best/https://mediadb.kicker.de/2016/fussball/vereine/xxl/98_20150723389.png"
)


download.file(icon_urls, method = "libcurl", mode = "wb", 
              destfile = paste0(target_dir, "team_2024_", stringr::str_pad(1:18, side = "left", pad = "0", width = 2), ".png"))
