...
Country rankings and coefficients were scraped from https://kassiesa.home.xs4all.nl/bert/uefa/data/index.html using the ``rvest`` package. The website provides datasets of UEFA country coefficients from 1960 to today. Note there were multiple changes to the calculation of the coefficients.
